...
from allauth_sniperlinks.utils import get_mx_domian_and_provider, USER_SNIPERLINK_CACHE_KEY
...
def update_sniperlink_and_clear_cache(sender, instance, created, **kwargs):
    ...
    cache.delete(USER_SNIPERLINK_CACHE_KEY.format(instance.user.id))